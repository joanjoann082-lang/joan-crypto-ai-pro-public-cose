...
VERSION = "MICRO_CANARY_OUTCOME_FEEDBACK_V10"
...
class MicroCanaryOutcomeFeedbackV10:
    """Feedback/cooldown from V10 net micro-canary outcomes."""
    ...
    def ensure_schema(self) -> None:
        self.db.execute("""
            CREATE TABLE IF NOT EXISTS micro_canary_outcome_feedback_v10 (
        ...
        """)
        self.db.execute("DROP VIEW IF EXISTS latest_micro_canary_outcome_feedback_v10;")
        self.db.execute("""
            CREATE VIEW latest_micro_canary_outcome_feedback_v10 AS
            SELECT * FROM micro_canary_outcome_feedback_v10
    ...
    def refresh(self) -> Dict[str, Any]:
        ...
        self.db.execute("""
            INSERT INTO micro_canary_outcome_feedback_v10 (
...
def main() -> None:
    ...
    engine = MicroCanaryOutcomeFeedbackV10()
    if args.refresh:
