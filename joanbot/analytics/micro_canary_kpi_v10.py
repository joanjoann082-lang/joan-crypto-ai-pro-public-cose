...
VERSION = "MICRO_CANARY_KPI_ENGINE_V10"
...
class MicroCanaryKPIEngineV10:
    ...
    def ensure_schema(self) -> None:
        self.db.execute("""
            CREATE TABLE IF NOT EXISTS micro_canary_kpi_v10 (
        ...
        """)
        self.db.execute("DROP VIEW IF EXISTS latest_micro_canary_kpi_v10;")
        self.db.execute("""
            CREATE VIEW latest_micro_canary_kpi_v10 AS
            SELECT * FROM micro_canary_kpi_v10
    ...
    def refresh(self) -> Dict[str, Any]:
        self.ensure_schema()
        all_rows = self.qmany("SELECT * FROM paper_micro_canary_positions_v10 ORDER BY id ASC;")
        ...
        self.db.execute("""
            INSERT INTO micro_canary_kpi_v10 (
...
def main() -> None:
    ...
    engine = MicroCanaryKPIEngineV10()
    if args.refresh:
